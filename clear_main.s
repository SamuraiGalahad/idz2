...
# ./main.c:24:             putc(ch, stdout);    // echo out
	...
	call	putc@PLT	#
# ./main.c:25:             str[i++] = ch;
	mov	eax, DWORD PTR -8[rbp]	# i.1_2, i
	lea	edx, 1[rax]	# tmp95,
	mov	DWORD PTR -8[rbp], edx	# i, tmp95
...
# ./main.c:44:         if (code > max_int && code != 4) {
	...
	cmp	eax, DWORD PTR -8[rbp]	# tmp102, max_int
	jle	.L10	#,
# ./main.c:44:         if (code > max_int && code != 4) {
	cmp	DWORD PTR -4[rbp], 4	# code,
	je	.L10	#,
...
# ./main.c:46:             max_int = code;
	...
	mov	DWORD PTR -8[rbp], eax	# max_int, tmp106
.L10:
# ./main.c:48:         i++;
	add	DWORD PTR -16[rbp], 1	# i,
.L8:
# ./main.c:38:     while (str[i] != '\0') {
	mov	eax, DWORD PTR -16[rbp]	# tmp107, i
